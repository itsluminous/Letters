...
export default function DemoPage() {
  ...
  const [scrollMode, setScrollMode] = useState<"view" | "edit" | "compose">(
    "view"
  );
    ...
    <div className="min-h-screen p-8 papyrus-texture">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-papyrus-text-light font-body">
            Click on any letter in the stack to select it. The stack shows up to
            5 letters with 3D stacking effects, rotation variance, and
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <LetterStack
                ...
                currentIndex={mockLetters.findIndex(
                  (l) => l.id === selectedLetterId
                )}
              />
            </div>
            <div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-papyrus-text-light font-body">
            Use arrow buttons, keyboard arrows (← →), swipe gestures (mobile),
            or horizontal scroll/wheel (desktop) to navigate between letters.
          </p>
          <LetterNavigation
            letters={mockLetters}
          ...
          >
            {(letter) => (
              <PapyrusScroll letter={letter} mode="view" showActions={false} />
            )}
          </LetterNavigation>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2">
            <p className="font-heading text-xl">
              Heading Font (Cinzel): The quick brown fox jumps over the lazy dog
            </p>
            <p className="font-body text-lg">
              Body Font (Lora): The quick brown fox jumps over the lazy dog
            </p>
            <p className="font-handwriting text-2xl">
              Handwriting Font (Caveat): The quick brown fox jumps over the lazy
              dog
            </p>
          </div>
        </section>
